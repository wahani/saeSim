...
`saeSim` provides tools for simulation studies in the context of small area
estimation. It can be useful for simulation studies in the field of statistics
in general if you do not get scared away by the domain specific jargon. Two
external resources may be of interest in addition to this vignette:

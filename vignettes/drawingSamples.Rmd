...
sim_lm() %>% sim_sample(sample_srs(size = 10L))
sim_lm() %>% sim_sample(sample_srs(size = 0.05))
# srs in each domain/cluster
sim_lm() %>% sim_sample(sample_csrs(size = 10L))
sim_lm() %>% sim_sample(sample_csrs(size = rep(10L, 100)))
sim_lm() %>% sim_sample(sample_csrs(size = 0.05))
```
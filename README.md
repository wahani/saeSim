...
## 1     1     1 -3.26 -5.80 -1.29 -0.352  89.3
## 2     1     2  4.26  4.77 -1.29 -0.352 107  
## 3     1     3 -3.07  1.02 -1.29 -0.352  96.3
## 4     1     4  5.21  2.32 -1.29 -0.352 106  
## 5     1     5  1.91  8.53 -1.29 -0.352 109  
## 6     1     6 -2.66  3.76 -1.29 -0.352  99.5
## # ... with 9,994 more rows
```
...
## 1     1     1   0.575 6.62  F       107     108
## 2     1     2   3.77  0.226 F       104     108
## 3     1     3  12.6   1.07  F       114     108
## 4     2     1   6.64  5.01  F       112     106
## 5     2     2 - 0.842 3.41  F       103     106
## 6     2     3   4.50  0.359 F       105     106
```
...
## * <dbl>  <dbl>  <dbl> <dbl>           <dbl>
## 1  1.00  0.202  2.20  102             100  
## 2  2.00  0.103 -2.58   97.5           100  
## 3  3.00 -2.03   2.49  100              97.9
## 4  4.00  1.52  -1.41  100             101  
## 5  5.00 -0.649  0.413  99.8            99.3
## 6  6.00 -1.14   1.45  100              98.8
## # ... with 94 more rows
```
